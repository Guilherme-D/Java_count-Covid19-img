...
public class Img_process {
    ...
    static void getSelectedImage(int x_pressed, int x_released,
        ...
        int width = x_released - x_pressed;
        int height = y_released - y_pressed;
        ...
        //(BufferedImage) label_img.getImage();
        System.out.println("x+w = "+x_pressed+width);
        BufferedImage subimage = b_img.getSubimage(x_pressed, y_pressed, width-1, height-1);
    ...
    public static BufferedImage getHistogram(String img_path, ImageIcon imgicon){
    ...
    public static BufferedImage MatToIcon(Mat mat_img){
...
*/        
    ...
    public static void draw_rectangle_dragging(){
